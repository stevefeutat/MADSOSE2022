...
public class ToDoItemApplication extends Application {
    ...
    public static final String WEBAPP_API_BASEURL_LOCALHOST_FROM_ANDROIDSTUDIO_EMULATOR = "http://10.0.2.2:8080/api/todos";
    ...
    public Future<Boolean> checkConnectivity() {
        ...
        new Thread(() -> {
            try {
                HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(WEBAPP_API_BASEURL_LOCALHOST_FROM_ANDROIDSTUDIO_EMULATOR).openConnection();
